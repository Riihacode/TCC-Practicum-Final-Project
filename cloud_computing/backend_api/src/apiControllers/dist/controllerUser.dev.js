    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 9:
          ...
          fileUrl = user.profile_pic; // ✅ Validasi dasar untuk keamanan (optional tapi berguna)
        ...
        case 20:
          ...
          console.warn("[GCS WARNING] Gagal hapus file: ".concat(_context9.t0.message)); // Tetap lanjut karena ini bukan error kritis
